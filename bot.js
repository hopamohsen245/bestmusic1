...
client.on('ready', () => {
 ...
 client.user.setGame(` *help | ON ${client.guilds.size}  Servers `,"https://www.twitch.tv/3Vahr")
...
client.on('message', message => {
    ...
    if (message.author.id !== '350780696203231242') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
